function populateFormOnOpen() {
  ...
  populateGroupClassQuestion(formItemsMap, groupClasses);
}
...
function populateGroupClassQuestion(formItemsMap, groupClasses) {
  const groupClassTitle = "Would you like to sign your student up for any of these group classes";
...
function populateStudentQuestions(formItemsMap, studentName, lessons) {
  ...
  studentQuestions.some(title => {
    ...
    if (title.includes("Which of the private lessons below would you like to try to change to another time for")) {
