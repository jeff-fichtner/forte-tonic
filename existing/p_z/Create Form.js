const studentNames = [
  "Pai, Kian","Pai, Rivan","Paidipaty, Bodhi","Paidipaty, Deven","Paidipaty, Heath","Patchen, Maya","Patchen, Nicolai","Pothula, Lucia","Pross, Margaux","Purcell, Lachlan","Redfern, Charlotte","Reid, Lily","Reid, Trevor","Rivinus, Ned","Rocherolle, Sophie","Rogoff, Joseph","Roselin, Charlotte","Roth, Liam","Ryan, Skylar","Sanner, Caden","Sihota, Avia","Simmons, Elodie","Simmons, Jack","Simmons, Micah","Sirota Vélez, Eliz","Sirota Vélez, Sergei","Slowe, Michael","Soofer, Bryce","Sowul, Collier","Spinell, Henry","Stafford, Amelia","Staudt, Charlotte","Steele, Jay","Subramanian, Priyanka","Sweren, Nora","Swift, Spencer","Thomasma, Lincoln","Thompson, Nat","Thompson, Tolly","Thompson, Wesley","Truong, Trina","Tucker, Jordan","Tucker, Savannah","Turner, Lachlan","Uihlein, Chloe","Uihlein, Jamie","Van Voris, Annalise","Van Voris, Carolina","Van Voris, Connor","Walden, Lagi","Walden, Makenna","Weiss, Charlie","Yen, Hudson","Yen, Toby","Yoo, Gabriel","Young, Bennett","Zometa Martinez, Anahí","Zometa Martinez, Inti"
];
