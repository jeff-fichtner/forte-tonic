...
export class UpdateStudentRequest extends BaseRequest {
    ...
    applyToStudent(student) {
        ...
        if (this.emergencyContactName !== undefined) updates.emergencyContactName = this.emergencyContactName;
        if (this.emergencyContactPhone !== undefined) updates.emergencyContactPhone = this.emergencyContactPhone;
