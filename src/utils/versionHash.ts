 ...
 * @returns 8-character version hash
 */
export function generateFrontendVersionHash(): string {
  try {
    ...
    try {
      const gitHash: string = execSync('git rev-parse HEAD', {
        encoding: 'utf8',
...
export function getFrontendVersionHash(): string {
