/**
 * Period display-name helper (FR-005)
 *
 ...
 * @throws If `period` is not a recognized identifier (fail-loud per FR-003's
 *   spirit — an unknown period is a programming bug, not a runtime condition)
 */
